...
const buttonColorMap: Record<ToastType, string> = {
                ...
                <div className="flex p-4">
                    ...
                    <div className="ml-auto md:ml-2">
                        <button
                            type="button"
                            onClick={onClose}
                            className={`inline-flex h-4 w-4 items-center justify-center rounded-md text-sm transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 ${buttonColorMap[type]}`}
                        >
