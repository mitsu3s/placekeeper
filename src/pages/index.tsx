...
const Home: NextPage = () => {
    ...
    return (
        <div className="bg-slate-100 h-screen">
            ...
            <header className="z-30 flex items-center w-full h-24 sm:h-32 bg-[#7f7fff]">
            ...
            <section>
                <div className="px-4 py-12 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-[72px] bg-slate-100">
                    <div className="flex flex-col w-full mb-12 text-center">
                        ...
                        <p className="max-w-xl mx-auto mt-8 text-base leading-relaxed text-center text-gray-500">
                            Provides location storage, sharing, and route search on maps for each
                            user.
                            <br />
                        ...
                        <p
                            className="mx-auto mt-8 text-sm font-semibold text-[#7f7fff]"
                            title="read more"
                        >
                            {' '}
                            Have a Share Code? »{' '}
